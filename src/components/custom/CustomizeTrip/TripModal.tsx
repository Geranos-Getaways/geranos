...
const TripModal = () => {
  ...
  return (
    <>
      ...
      {/* Main Form Modal */}
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-40 z-50 flex items-center justify-center px-2 py-6">
          <div className="relative bg-white rounded-2xl shadow-xl max-w-3xl w-full flex flex-col md:flex-row overflow-hidden my-12 max-h-[90vh] overflow-y-auto">
            {/* Left Image */}
