  ...
  return (
    <Card className="border-none shadow-none w-full grid gap-6 bg-[#246BEB]">
      <blockquote className="text-md leading-relaxed md:text-md">
        <div
          className="text-white max-w-min testContCstCls font-UrbanistLight tracking-wide text-md sm:text-base"
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="grid">
          <div className="text-white font-bold font-UrbanistLight tracking-wide text-md sm:text-base">
            - {props.testimnlName}
          </div>
          {/* <div className="text-white text-sm text-muted-foreground">
            {props.testimnlDesignation}
          </div> */}
        </div>
      </div>
    </Card>
