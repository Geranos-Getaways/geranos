...
interface ExperienceData {
  ...
  acf?: {
    ...
    duration?: string;
    location?: string;
    highlight_images: Record<string, string>;
    tags?: string[];
    ...
    experience_full_description: string;
  };
}
    ...
    <div className="min-h-screen text-gray-800">
      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col lg:flex-row gap-12 py-10">
        ...
        <div className="flex-1">
          ...
          <div
            className={`text-gray-700 leading-relaxed prose max-w-none ${styles.listStyle}`}
            dangerouslySetInnerHTML={{
              __html: singleExperience?.acf?.experience_full_description || '',
            }}
          ></div>
        </div>
        ...
        <div className="flex-1">
          <div className="pt-8">
            <p className="">
              <span className="font-semibold text-2xl" style={{ color: '#246beb' }}>
          ...
          <div className="pt-8">
            ...
            <div
              ...
              className={`${styles.listStyle} prose max-w-none`}
            ></div>
          </div>
