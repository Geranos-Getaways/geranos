...
const page = ({ params }: { params: { state: string } }) => {
    ...
    return (
        ...
        {/* Hero Section */}
       {/* Hero Section */}
<div className="page-hero-section h-[500px] overflow-hidden relative">
  <img 
  ...
  <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center bg-black/30">
    <h1 className="text-4xl md:text-8xl font-bold drop-shadow-lg capitalize">{state}</h1>
    <p className="text-lg md:text-2xl mt-2 drop-shadow-md">Explore the unseen beauty of {state}</p>
  </div>
</div>
